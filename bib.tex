...
%% El Farol Bar
\bibitem{elfarol} {\sc Luis Miramontes Hercog, Terence C. Fogarty, London Se Aa} \textit{Social simulation using a multi-agent model based on classifier systems: The emergence of vacillating behaviour in the ``el farol'' bar problem},
Proceedings of the International Workshop in Learning Classifier Systems 2001, 2002, Springer-Verlag
...
\bibitem{xcs1} \textit{“Classifier fitness based on accuracy,”} Evol. Comput., vol. 3, no. 2, pp. 149–175, 1995
...
PARADISE Research Laboratory, University of Ottawa, HAVE 2008 – IEEE International Workshop on Haptic Audio Visual Environments and their Applications, Ottawa – Canada, 18-19 October 2008
