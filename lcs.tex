...
\item Auswahl auf die Sensordaten passender \emph{classifier} (\emph{matching}, siehe Kapitel~\ref{matching:sec})
...
\item Erstellung des zur Aktion zugehörigen Liste von \emph{classifier} (\emph{actionSet}, siehe Kapitel~\ref{actionSet:sec})
