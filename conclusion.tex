...
\chapter{Vorgehen und verwendete Hilfsmittel und Software}
...
Das Simulationsprogramm wurde samt zugehöriger Oberfläche zur Erstellung von neuen Test-Jobs in Netbeans 6.5 entwickelt und gestaltet. Für die Verlaufsgraphen wurde GnuPlot benutzt, die Darstellungen der jeweiligen Konfiguration des Torus (insbesondere in Kapitel~\ref{scenario_description:cha}) wurden im Programm mittels Gif89Encoder~\cite{gifencoder} erstellt. Weitere Graphen und Darstellungen wurden OpenOffice.org Impress und OpenOffice.org Calc erstellt.\\
...
Dieses Dokument schließlich wurde mittels dem \LaTeX Editor LEd 0.5263 erstellt und mittels MiKTeX 2.7 kompiliert.
