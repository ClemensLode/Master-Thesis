...
Säulenszenario:
Populationsgrößen mit und ohne zufälliger Initialisierung (covered actions)
Laufzeit mit und ohne zufälliger Initialisierung
...
\section{Vergleich unterschiedlicher Geschwindigkeiten des Zielobjekts} Säulenszenario
