...
Von den blockierten Bewegungen her konnte mit dieser Auswahlart einerseits die Zahl der blockierten Bewegungen reduziert (auf etwa 34\%) bei XCS  und andererseits weiterhin die Möglichkeit offengelassen, das Ziel zu verfolgen, wenn es in Sicht ist.\\

Insgesamt ist also zuammenzufassen, dass für ein Szenario mit wenigen Hindernissen die Auswahlart \emph{best selection} die beste Wahl ist und in Szenarien mit vielen Hindernissen ein Wechsel der \emph{roulette wheel selection} und \emph{best selection} Auswahlart die beste Wahl ist.\\
...
\begin{itemize}
\item SXCS und DSXCS haben in etwa den selben Verlauf.
...
\subsection{Vergleich von SXCS mit intelligenter Heuristik im schwierigen Szenario}
...
\item Die Weitergabe des \emph{reward} Werts basierte auf der Idee, nichtbeteiligte Agenten an einem posiiven \emph{base reward} zu beteiligen, da sie trotzdem ein Gebiet überwachen.
