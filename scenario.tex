\chapter{Beschreibung des Szenarios}
...
\section{Definition einer Probleminstanz}
...
TODO Zielobjektabdeckung! (in 100 Schritten abgedecktes Gebiet o.ä.)
...
Hier wird der Torus an der rechten Seite vollständig durch Hindernisse blockiert, um den Torus zu halbieren. Alle Agenten starten (zufällig verteilt) am linken Rand, der Zielagent startet auf der rechten Seite.\\
...
Idee dieses Szenarios ist es, zu testen, inwieweit die Agenten durch die Öffnungen zum Ziel finden können. Ohne Orientierung an den Öffnungen und anderen Agenten ist es sehr schwierig, sich durch das Szenario zu bewegen. Abbildung~\ref{difficult_grid:fig} zeigt die Startkonfiguration des Szenarios.
