...
Dies ist ein wesentlicher Gesichtspunkt, den diese Arbeit von vielen anderen unterscheidet, Gegenstand der Untersuchung in der Literatur sind eher statische Probleme wie z.B. 6-Multiplexer Problem und Maze1 (z.B. in ~\cite{Butz2006}) bzw. Maze5, Maze6, Woods14 (in ~\cite{Butz2005}) oder Probleme bei denen die Agenten globale Information besitzen. Eine nähere Diskussion zur Literatur gibt es in Kapitel~\ref{lcs:cha}.
