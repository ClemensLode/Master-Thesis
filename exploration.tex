...
\caption[Vergleich verschiedener Werte $p$ für Auswahlart \emph{tournament selection}]{Vergleich verschiedener Werte $p$ für Auswahlart \emph{tournament selection} (Zielagent mit einfacher Richtungsänderung, Säulenszenario, 8 Agenten, SXCS)}
...
\hline
Andauernd \emph{explore, roulette wheel selection} &  4,54\% & 72,10\% & 30,30\% \\
Andauernd \emph{explore, random selection}         &  4,34\% & 72,21\% & 28,50\% \\
\bf{Andauernd \emph{exploit, tournament selection}}     & 11,21\% & 70,20\% & \bf{33,39\%} \\
Andauernd \emph{exploit, best selection}           & 41,16\% & 63,64\% & 29,22\% \\
Zufällig \emph{explore}/\emph{exploit}             &  6,29\% & 71,18\% & 30,58\% \\
Abwechselnd, beginnend mit \emph{explore}          &  5,63\% & 71,37\% & 26,30\% \\
\bf{Abwechselnd, beginnend mit \emph{exploit}}          &  9,28\% & 70,40\% & \bf{35,36\%} \\[1ex]
\hline
\end{tabular}
