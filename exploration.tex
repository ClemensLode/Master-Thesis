...
In der ursprünglichen Implementierung \cite{Butz_xcsclassifier} wurden dann folgende Arten beschrieben, wie eine der vier Aktionen ausgewählt werden kann:
...
\begin{figure}[H]
\setbox0\vbox{\small
Es sollen nun also folgende Arten des Wechsels zwischen den Phasen untersucht werden:
\begin{enumerate}
