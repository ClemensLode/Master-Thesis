...
In Tests ergab sich für die quadratische Rewardvergabe ein minimal besseres Ergebnis (TODO zeigen), weitere Grafiken werden auf die lineare Rewardvergabe beschränkt sein um eine verständliche Darstellung zu ermöglichen, während in den Simulationen die quadratische Rewardvergabe benutzt wird.
