...
%TODO?
%1.Vollständig neu organisierte Berechnung der.. und Korrektur eines Fehlers bei %..
%2.Der …
%3.Qualitätsmessung des Algorithmus nicht nur .. Phase, da …
%5.Neuformulierung des Ziels für das Überwachungsszenario und Neuregelung des %Neustarts von Probleminstanzen
%6.Überdenken der Reihenfolge …Torus.

\begin{itemize}
\item Vollständig neu organisierte Berechnung der Summe der \emph{numerosity} Werte wurde vollständig neuorganisiert wie auch ein Fehler bei der Aktualisierung des \emph{numerosity} Werts in der Implementierung korrigiert (siehe Kapitel~\ref{corrected_numerosity_function:sec}).
