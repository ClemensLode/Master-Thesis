...
Die zum Agenten zugehörigen \emph{classifer} (das sogenannte \emph{classifier set}) sind in Abbildung~\ref{simple_scenario_multistep_classifier:fig} dargestellt, wobei die vier angrenzenden Felder für jeden \emph{classifier} jeweils die Konfiguration der Kondition darstellen und der Pfeil die Aktion.\\
...
\section{Wesentliche Erkenntnisse aus dieser Arbeit}\label{wesentliche_erkenntnisse_int:sec}
